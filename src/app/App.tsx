...
const contactFaqs = [
  { q: "What happens on the discovery call?", a: "A 30-minute walkthrough of your specific use case, such as cost forecasting, RFQ response, or margin management. We'll show how Saphran connects to your existing ERP or PLM and what a deployment looks like for your operation." },
